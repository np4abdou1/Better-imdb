...
export async function GET(request, { params }) {
  ...
  try {
    ...
    const response = await retryWithBackoff(() =>
      axios.get(`${API_BASE}/titles/${id}/awardNominations`, {
        params: queryParams,
    ...
    console.error('Award Nominations API Error:', error.message);
    ...
    return NextResponse.json({ error: 'External API Error', awardNominations: [] }, { status: 500 });
  }
}
